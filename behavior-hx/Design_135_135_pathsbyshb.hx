...
class Design_135_135_pathsbyshb extends ActorScript
{          	
            ...
            if(((actor.alpha * 100) == 100))
{
                ...
                Engine.engine.setGameAttribute("SelectedPath", "sby_sh");
                Engine.engine.setGameAttribute("RoomName", "Guard House");
                Engine.engine.setGameAttribute("RoomDesc", "No Description Yet");
                Engine.engine.setGameAttribute("RoomImg", "gh");
}
