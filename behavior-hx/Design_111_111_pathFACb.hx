...
class Design_111_111_pathFACb extends ActorScript
{          	
            ...
            if(((actor.alpha * 100) == 100))
{
                ...
                Engine.engine.setGameAttribute("SelectedPath", "FAC");
                Engine.engine.setGameAttribute("RoomName", "Faculty Office");
                Engine.engine.setGameAttribute("RoomDesc", "No Description Yet");
                Engine.engine.setGameAttribute("RoomImg", "fac");
}
