...
class Design_195_195_btnmur14b extends ActorScript
{          	
            ...
            if(((actor.alpha * 100) == 100))
{
                ...
                Engine.engine.setGameAttribute("SelectedPath", "14");
                Engine.engine.setGameAttribute("RoomName", "Crop Processing");
