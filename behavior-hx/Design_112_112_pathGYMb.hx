...
class Design_112_112_pathGYMb extends ActorScript
{          	
            ...
            if(((actor.alpha * 100) == 100))
{
                ...
                Engine.engine.setGameAttribute("SelectedPath", "GYM");
                Engine.engine.setGameAttribute("RoomName", "Gymnasium");
                Engine.engine.setGameAttribute("RoomDesc", "No Description Yet");
                Engine.engine.setGameAttribute("RoomImg", "gym");
}
