...
class Design_133_133_pathsbyscib extends ActorScript
{          	
            ...
            if(((actor.alpha * 100) == 100))
{
                ...
                Engine.engine.setGameAttribute("SelectedPath", "sby_sci");
                Engine.engine.setGameAttribute("RoomName", "Science Laboratory");
                Engine.engine.setGameAttribute("RoomDesc", "No Description Yet");
                Engine.engine.setGameAttribute("RoomImg", "scilab");
}
