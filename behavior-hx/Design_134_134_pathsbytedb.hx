...
class Design_134_134_pathsbytedb extends ActorScript
{          	
            ...
            if(((actor.alpha * 100) == 100))
{
                ...
                Engine.engine.setGameAttribute("SelectedPath", "sby_ted");
                Engine.engine.setGameAttribute("RoomName", "TED Faculty");
                Engine.engine.setGameAttribute("RoomDesc", "No Description Yet");
                Engine.engine.setGameAttribute("RoomImg", "tedfac");
}
