...
class Design_205_205_btnmur24b extends ActorScript
{          	
            ...
            if(((actor.alpha * 100) == 100))
{
                ...
                Engine.engine.setGameAttribute("SelectedPath", "24");
                Engine.engine.setGameAttribute("RoomName", "Production Plant 1");
