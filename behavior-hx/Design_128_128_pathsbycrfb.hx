...
class Design_128_128_pathsbycrfb extends ActorScript
{          	
            ...
            if(((actor.alpha * 100) == 100))
{
                ...
                Engine.engine.setGameAttribute("SelectedPath", "sby_crf");
                Engine.engine.setGameAttribute("RoomName", "Comfort Room - Female");
                Engine.engine.setGameAttribute("RoomDesc", "No Description Yet");
                Engine.engine.setGameAttribute("RoomImg", "crf");
}
