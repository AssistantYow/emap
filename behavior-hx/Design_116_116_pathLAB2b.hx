...
class Design_116_116_pathLAB2b extends ActorScript
{          	
            ...
            if(((actor.alpha * 100) == 100))
{
                ...
                Engine.engine.setGameAttribute("SelectedPath", "LAB2");
                Engine.engine.setGameAttribute("RoomName", "Laboratory 2");
                Engine.engine.setGameAttribute("RoomDesc", "No Description Yet");
                Engine.engine.setGameAttribute("RoomImg", "lab2");
}
