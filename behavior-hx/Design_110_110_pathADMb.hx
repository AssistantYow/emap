...
class Design_110_110_pathADMb extends ActorScript
{          	
            ...
            if(((actor.alpha * 100) == 100))
{
                ...
                Engine.engine.setGameAttribute("SelectedPath", "ADM");
                Engine.engine.setGameAttribute("RoomName", "Administrator Office");
                Engine.engine.setGameAttribute("RoomDesc", "No Description Yet");
                Engine.engine.setGameAttribute("RoomImg", "adm");
}
