...
class Design_192_192_btnmur11b extends ActorScript
{          	
            ...
            if(((actor.alpha * 100) == 100))
{
                ...
                Engine.engine.setGameAttribute("SelectedPath", "11");
                Engine.engine.setGameAttribute("RoomName", "College Library");
