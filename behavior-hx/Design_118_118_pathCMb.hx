...
class Design_118_118_pathCMb extends ActorScript
{          	
            ...
            if(((actor.alpha * 100) == 100))
{
                ...
                Engine.engine.setGameAttribute("SelectedPath", "CM");
                Engine.engine.setGameAttribute("RoomName", "Canteen and Marketing");
                Engine.engine.setGameAttribute("RoomDesc", "No Description Yet");
                Engine.engine.setGameAttribute("RoomImg", "cm");
}
