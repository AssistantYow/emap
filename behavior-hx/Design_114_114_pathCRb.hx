...
class Design_114_114_pathCRb extends ActorScript
{          	
            ...
            if(((actor.alpha * 100) == 100))
{
                ...
                Engine.engine.setGameAttribute("SelectedPath", "CR");
                Engine.engine.setGameAttribute("RoomName", "Comfort Room");
                Engine.engine.setGameAttribute("RoomDesc", "No Description Yet");
                Engine.engine.setGameAttribute("RoomImg", "cr");
}
