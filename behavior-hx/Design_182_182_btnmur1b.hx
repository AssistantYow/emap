...
class Design_182_182_btnmur1b extends ActorScript
{          	
            ...
            if(((actor.alpha * 100) == 100))
{
                ...
                Engine.engine.setGameAttribute("SelectedPath", "1");
                Engine.engine.setGameAttribute("RoomName", "Administration Bldg.");
