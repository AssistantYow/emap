...
class Design_119_119_pathComLabb extends ActorScript
{          	
            ...
            if(((actor.alpha * 100) == 100))
{
                ...
                Engine.engine.setGameAttribute("SelectedPath", "ComLab");
                Engine.engine.setGameAttribute("RoomName", "Computer Laboratory");
                Engine.engine.setGameAttribute("RoomDesc", "No Description Yet");
                Engine.engine.setGameAttribute("RoomImg", "cl");
}
