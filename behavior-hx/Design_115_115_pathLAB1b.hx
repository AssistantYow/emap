...
class Design_115_115_pathLAB1b extends ActorScript
{          	
            ...
            if(((actor.alpha * 100) == 100))
{
                ...
                Engine.engine.setGameAttribute("SelectedPath", "LAB1");
                Engine.engine.setGameAttribute("RoomName", "Laboratory 1");
                Engine.engine.setGameAttribute("RoomDesc", "No Description Yet");
                Engine.engine.setGameAttribute("RoomImg", "lab1");
}
