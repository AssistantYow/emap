...
class Design_129_129_pathsbycrmb extends ActorScript
{          	
            ...
            if(((actor.alpha * 100) == 100))
{
                ...
                Engine.engine.setGameAttribute("SelectedPath", "sby_crm");
                Engine.engine.setGameAttribute("RoomName", "Comfort Room - Male");
                Engine.engine.setGameAttribute("RoomDesc", "No Description Yet");
                Engine.engine.setGameAttribute("RoomImg", "crm");
}
