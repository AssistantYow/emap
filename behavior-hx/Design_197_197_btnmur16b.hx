...
class Design_197_197_btnmur16b extends ActorScript
{          	
            ...
            if(((actor.alpha * 100) == 100))
{
                ...
                Engine.engine.setGameAttribute("SelectedPath", "16");
                Engine.engine.setGameAttribute("RoomName", "Audio Visual Room");
