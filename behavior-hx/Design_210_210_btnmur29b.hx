...
class Design_210_210_btnmur29b extends ActorScript
{          	
            ...
            if(((actor.alpha * 100) == 100))
{
                ...
                Engine.engine.setGameAttribute("SelectedPath", "29");
                Engine.engine.setGameAttribute("RoomName", "Marketing Center");
