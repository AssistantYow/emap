...
class Design_130_130_pathsbycrimeb extends ActorScript
{          	
            ...
            if(((actor.alpha * 100) == 100))
{
                ...
                Engine.engine.setGameAttribute("SelectedPath", "sby_crime");
                Engine.engine.setGameAttribute("RoomName", "Criminology Room");
                Engine.engine.setGameAttribute("RoomDesc", "No Description Yet");
                Engine.engine.setGameAttribute("RoomImg", "crime");
}
