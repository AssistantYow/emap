...
class Design_202_202_btnmur21b extends ActorScript
{          	
            ...
            if(((actor.alpha * 100) == 100))
{
                ...
                Engine.engine.setGameAttribute("SelectedPath", "21");
                Engine.engine.setGameAttribute("RoomName", "PhilVolcanic Radar");
