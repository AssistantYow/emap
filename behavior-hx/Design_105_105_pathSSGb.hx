...
class Design_105_105_pathSSGb extends ActorScript
{          	
            ...
            if(((actor.alpha * 100) == 100))
{
                ...
                Engine.engine.setGameAttribute("SelectedPath", "SSG");
                Engine.engine.setGameAttribute("RoomName", "SSG Office");
                Engine.engine.setGameAttribute("RoomDesc", "No Description Yet");
                Engine.engine.setGameAttribute("RoomImg", "ssg");
}
