...
class Design_203_203_btnmur22b extends ActorScript
{          	
            ...
            if(((actor.alpha * 100) == 100))
{
                ...
                Engine.engine.setGameAttribute("SelectedPath", "22");
                Engine.engine.setGameAttribute("RoomName", "Poultry Production");
