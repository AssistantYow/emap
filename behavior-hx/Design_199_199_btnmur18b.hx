...
class Design_199_199_btnmur18b extends ActorScript
{          	
            ...
            if(((actor.alpha * 100) == 100))
{
                ...
                Engine.engine.setGameAttribute("SelectedPath", "18");
                Engine.engine.setGameAttribute("RoomName", "COC Bldg/ RDE Unit");
