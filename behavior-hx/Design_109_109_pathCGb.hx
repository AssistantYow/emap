...
class Design_109_109_pathCGb extends ActorScript
{          	
            ...
            if(((actor.alpha * 100) == 100))
{
                ...
                Engine.engine.setGameAttribute("SelectedPath", "CG");
                Engine.engine.setGameAttribute("RoomName", "Clinic and Guidance Office");
                Engine.engine.setGameAttribute("RoomDesc", "No Description Yet");
                Engine.engine.setGameAttribute("RoomImg", "cg");
}
